 ...
 *
 * This is used to transport data generated by the authentication directive to the wskscheduler.
 * The wskscheduler can passed this data to the user container.
 *
